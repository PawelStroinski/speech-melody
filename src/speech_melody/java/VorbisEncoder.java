...
public class VorbisEncoder {
	...
	public static void encode( InputStream input, File output, int frameRate, String title, String artist )
            throws IOException {
		...
		if ( !encoder.vorbis_encode_init_vbr( vi, 2, frameRate, .3f ) ) {
        ...
        vc.vorbis_comment_add_tag( "TITLE", title );
        vc.vorbis_comment_add_tag( "ARTIST", artist );
